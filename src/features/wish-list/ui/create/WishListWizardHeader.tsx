...
import WishListWizardStepper from '~/features/wish-list/ui/create/WishListWizardStepper';
...
const WishListWizardHeader = ({
  ...
  return (
    <View className="sticky top-0 z-10 border-b border-border bg-card/95 backdrop-blur px-4 py-4 sm:px-6">
      ...
      <WishListWizardStepper currentIndex={currentIndex} />
    </View>
  );
};

export default WishListWizardHeader;
