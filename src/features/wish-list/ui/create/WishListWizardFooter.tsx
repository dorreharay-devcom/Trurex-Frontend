...
const WishListWizardFooter = ({ isLastStep, isEditMode, disabled, submitting, onPress }: Props) => {
  return (
    <View className="sticky bottom-0 items-center border-t border-border bg-card/95 px-4 py-4 backdrop-blur sm:px-6">
      <View className="w-full" style={{ maxWidth: 512 }}>
        <Pressable
          ...
          accessibilityLabel={
            isLastStep ? (isEditMode ? 'Save changes' : 'Add to Wish List') : 'Continue'
          }
...
export default WishListWizardFooter;
