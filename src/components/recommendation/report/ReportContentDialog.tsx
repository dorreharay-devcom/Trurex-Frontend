  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <View
          className={isWeb ? 'w-full items-center' : 'w-full'}
          pointerEvents="box-none"
        >
          {sheetShell(
        <View
            ...
            <View className="mb-1 flex-row items-center justify-end px-2">
                ...
                {user == null ? (
                  ...
                  <>
                    <View className="mb-3 flex-row items-start gap-2">
                      <ShieldAlert size={20} color={Theme.colors.secondaryText} style={{ marginTop: 2 }} />
              ...
              {user ? (
                <View className="mt-1 flex-row justify-end gap-2 border-t border-border px-4 pt-3">
                  ...
                  >
                    <Text className="text-sm font-semibold text-primary-foreground">Submit report</Text>
                  </Pressable>
                </View>
              ) : null}
          </>
