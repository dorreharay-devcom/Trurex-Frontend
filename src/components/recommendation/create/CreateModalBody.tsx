...
import { mapSubcategoriesFromConfig } from '~/utils/recommendation/rexSubcategories';
          ...
          <>
            {flow.stepId === 'search' && (
              <Search
                ...
                onlineLocationText={flow.onlineLocationText}
                onOnlineLocationTextChange={flow.setOnlineLocationText}
                onlineGeotag={flow.onlineGeotag}
