...
import { GoogleGMark } from '~/components/auth/oauth/GoogleGMark';
import { AppleLogoMark } from '~/components/auth/oauth/AppleLogoMark';
...
export function OAuthSocialButtons({ onGooglePress, onApplePress, disabled }: Props) {
  return (
